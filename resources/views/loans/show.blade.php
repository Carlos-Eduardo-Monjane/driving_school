...
<x-app-layout>
    ...
    <x-slot name="title">
        Empréstimo #{{$loan->id}} @if(!$loan->is_active) [Closed] @endif
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary"> Detalhes do empréstimo</h6>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        @for($i=0; $i < 2; $i++) <div class="col-6">
            <div class="card my-2">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary">Fiador {{$i + 1}}</h6>
                </div>
                <div class="card-body">
