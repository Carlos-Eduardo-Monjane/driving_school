...
<x-app-layout>
    <x-slot name="title">
        @if(!$isEdit)Criar um @else Editar @endif Empréstimo
    </x-slot>

    @if (session('status'))
    <div class="alert alert-success">
        Empréstimo foi @if(!$isEdit) criado. @else editado. @endif <u><a href="{{route('loans.index')}}">Ver a lista</a></u>
    </div>
    @endif
    ...
    <script>
        $(document).ready(function() {
            ...
            function calculateRental() {
                ...
                var rental = Math.ceil((parseFloat(amount) + (parseFloat(amount) * interest_percentage)) / parseInt(installments));
