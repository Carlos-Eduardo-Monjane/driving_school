...
<x-app-layout>
    <x-slot name="title">
        @if(!$isEdit)Criar um @else Editar @endif usuário
    </x-slot>

    @if (session('status'))
    <div class="alert alert-success">
        O usuário foi @if(!$isEdit) criado com sucesso. @else editado com sucesso. @endif <u><a href="{{route('users.index')}}">Ver a lista</a></u>
    </div>
    @endif
