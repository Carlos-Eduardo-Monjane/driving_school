...
class Loan extends Model
{
    ...
    protected $appends = ['last_payment', 'outstanding_amount', 'daily_rental', 'status_text', 'remaining_days'];
    ...
    public function getRemainingDaysAttribute()
    {
        ...
        return $this->is_active ? $this->installments - $this->start_date->diffInDays($now) : '--';
    }

    public function getOutstandingAmountAttribute()
    {
        $paidAmount = $this->payments->sum('amount');
        return $this->full_loan_amount - $paidAmount;
    }

    public function getStatusTextAttribute()
    {
        return $this->is_active ? 'Aberto' : 'Fechado';
    }
